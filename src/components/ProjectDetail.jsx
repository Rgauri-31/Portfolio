  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || 'https://github.com/Rgauri-31',
      };
            ...
            <div className="space-y-6 md:space-y-10 animate-slideInLeft">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
               ...
               <a
                 ...
                 className="group relative inline-flex items-center space-x-2 px-6 py-3
                 bg-gradient-to-r from-purple-600/10 to-pink-600/10
                 hover:from-purple-600/20 hover:to-pink-600/20
                 text-purple-300 rounded-xl transition-all duration-300
                ...
                <span className="text-gray-400 text-sm">GitHub link coming soon</span>
                )}
              </div>
